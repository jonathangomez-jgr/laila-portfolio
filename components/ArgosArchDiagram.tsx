...
const SF_P1: ArchNode[] = [
  ...
  { id: "slack",          name: "Slack",              subtitle: "SO del asesor · ciclo de venta + Slackbot",   pillars: ["P1"], description: "Sistema operativo del asesor y del equipo comercial: Slack es la base donde se gestiona el ciclo completo de venta del CRM. Crear, modificar y actualizar oportunidades, dejar registro de visitas y operar la Vista 360 sin salir de la conversación, con Slackbot guiando el flujo. Reemplaza los grupos de WhatsApp internos y consolida la información en una sola interfaz.", bullets: ["Crear, modificar y actualizar oportunidades del CRM desde Slack","Registro de visitas conversacional con Slackbot","Vista 360 del cliente accesible desde la conversación","Alertas RADAR en tiempo real al asesor correcto","Aprobaciones de descuento y crédito","Reemplaza grupos WhatsApp internos — trazabilidad completa"] },
];
