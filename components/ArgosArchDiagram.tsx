...
const SF_P1: ArchNode[] = [
  ...
  { id: "slack",          name: "Slack",              subtitle: "SO del asesor · pestaña Hoy + Slackbot + RADAR",   pillars: ["P1"], description: "Sistema operativo del asesor y del equipo comercial. Carlos arranca el día en la pestaña 'Hoy' de Slack — tareas, foco y agenda en una sola pantalla. Slackbot prepara cada reunión, devuelve el briefing con el RADAR del día, responde la Vista 360 conversando dentro del chat y permite registrar visitas y actualizar oportunidades sin abrir el CRM. Las alertas RADAR llegan en tiempo real al asesor correcto. Reemplaza los grupos de WhatsApp internos y consolida la información en una sola interfaz.", bullets: ["Pestaña Hoy: foco, tareas y agenda del día en una pantalla","Preparar reunión con Slackbot — briefing + RADAR en el chat","Vista 360 del cliente conversacional, sin abrir el CRM","Alertas RADAR en tiempo real al asesor correcto","Crear, modificar y registrar oportunidades + visitas desde Slack","Aprobaciones de descuento y crédito desde el mismo canal","Reemplaza grupos WhatsApp internos — trazabilidad completa"] },
];
