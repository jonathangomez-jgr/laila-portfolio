...
export default function LailaDemoPage() {
  return (
    <main>
      <PageHero
        eyebrow="Laila / Demo"
        title="Demo de Laila."
        description="Espacio para mostrar videos, capturas, flujos o una explicación interactiva de lo que Laila permite construir."
      />
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 md:px-8">
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-start md:gap-16">
          ...
          <div className="flex w-full flex-col items-center rounded-3xl border border-gray-100 bg-white p-8 shadow-sm md:w-auto md:min-w-[300px]">
            <p className="eyebrow mb-5">Escaneá y chateá</p>
            ...
            <p className="mt-1 text-center text-sm text-gray-500">
              Escaneá el código con tu cámara para abrir WhatsApp directamente.
            </p>
          ...
          <div className="flex-1">
            ...
            <h2 className="section-title text-2xl font-semibold text-gray-950 sm:text-3xl">
              Videos, capturas y recorridos interactivos.
            </h2>
            <p className="mt-4 max-w-xl text-base leading-7 text-gray-600">
              Esta sección irá incorporando demos en video, flujos narrados y prototipos que muestran a Laila en acción en conversaciones reales con clientes.
            </p>
          </div>
