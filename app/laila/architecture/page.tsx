    ...
    <main>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 md:px-8">
        <div className="mb-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-gray-600">
            Archivos descargables y materiales de referencia del sistema Laila.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-gray-900">Laila System Landscape</p>
              <p className="mt-0.5 text-xs text-gray-500">Diagrama completo · PDF</p>
            </div>
            <svg className="ml-auto h-4 w-4 shrink-0 text-gray-300 transition group-hover:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
