    ...
    <main className="px-4 pb-16 pt-8 sm:px-6 sm:pt-10 md:px-8 md:pt-14">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="section-title max-w-3xl text-3xl font-semibold tracking-tight text-gray-950 sm:text-5xl">
            {d.title}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_1.2fr]">
          ...
          {/* About card */}
          <div className="relative overflow-hidden rounded-[28px] border border-indigo-200/50 bg-gradient-to-br from-indigo-500 via-blue-500 to-sky-400 p-8 text-white shadow-[0_24px_70px_rgba(79,70,229,0.22)]">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-6 flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
                <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-full border-4 border-white/30 bg-white/15 shadow-lg">
                  <Image
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-white">{a.profileName}</h2>
                  <p className="mt-1 text-sm text-white/85">{a.profileRole}</p>
                </div>
              </div>

              <p className="mt-6 text-sm leading-7 text-white/80">{d.aboutDesc}</p>

              <div className="mt-6 flex flex-wrap gap-2">
                {["Solution Design", "Executive Storytelling", "Salesforce", "Agentforce", "Data Cloud", "AI Solutions"].map((skill) => (
                  <span
                    key={skill}
                    className="rounded-full border border-white/25 bg-white/15 px-3 py-1 text-xs font-semibold text-white/90 backdrop-blur-sm"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <div className="mt-8 grid grid-cols-2 gap-3">
                {a.highlights.slice(0, 4).map((item) => (
                  <div
                    key={item.label}
          ...
          <div className="flex flex-col gap-6">
            <p className="eyebrow">{d.channelsEyebrow}</p>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              <a
                ...
                className="group flex flex-col items-center justify-between gap-4 rounded-2xl border border-green-200 bg-gradient-to-b from-green-50 to-white p-7 text-center transition hover:-translate-y-1 hover:shadow-lg"
              >
                ...
                <div>
                  <h2 className="mb-1 text-xl font-semibold text-gray-950">
                    {d.whatsappTitle}
                  </h2>
                  <p className="text-xs text-gray-500">{d.whatsappSub}</p>
                </div>
                <span className="rounded-full bg-green-500 px-5 py-2.5 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(34,197,94,0.3)] transition group-hover:bg-green-600">
                  {d.whatsappBtn}
                </span>
              </a>
        ...
        {/* ── Profiles & Networks ─────────────────────────────────────── */}
        <div className="mt-8">
          <p className="eyebrow mb-5">{d.linksEyebrow ?? d.findMeTitle}</p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-xs text-gray-500">in/jonathangomezr</p>
              </div>
              <svg className="ml-auto h-4 w-4 shrink-0 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-[#0a66c2]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden>
            ...
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#032D61]">
                <Image src="/trailhead.png" alt="Trailhead" width={36} height={36} className="h-[50%] w-[50%] object-contain" />
              </div>
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-gray-950">Trailblazer</p>
                <p className="truncate text-xs text-gray-500">trailblazer/jgomez30</p>
              </div>
              <svg className="ml-auto h-4 w-4 shrink-0 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-[#00a1e0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
            </a>
            ...
            >
              ...
              <svg className="ml-auto h-4 w-4 shrink-0 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
            </a>
          </div>
