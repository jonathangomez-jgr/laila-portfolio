      ...
      <section className="mx-auto max-w-5xl px-5 py-8 sm:px-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div>
              <h2 className="mb-1 text-2xl font-semibold text-gray-950">
                {d.whatsappTitle}
              </h2>
              <p className="text-sm text-gray-500">{d.whatsappSub}</p>
            </div>
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-8">
            ...
            >
              ...
              <svg
                className="ml-auto h-4 w-4 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-[#0a66c2]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
            ...
            >
              ...
              <svg
                className="ml-auto h-4 w-4 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-[#00a1e0]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
            ...
            >
              ...
              <svg
                className="ml-auto h-4 w-4 shrink-0 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-[#ff0000]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
            ...
            >
              ...
              <svg
                className="ml-auto h-4 w-4 text-gray-400 transition group-hover:translate-x-0.5 group-hover:text-gray-800"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
